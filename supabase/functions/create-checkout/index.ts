...
const PLANS = {
  lite: {
    name: "Win Streak Premium Lite",
    description: "Jogos ao vivo, odds detalhadas, detector de surebets",
    amount: 1990, // R$19,90
  },
  pro: {
    name: "Win Streak Premium Pro",
    description: "Todos os recursos: IA, análises, bilhetes, NBA, surebets e mais",
    amount: 3990, // R$39,90
  },
};
